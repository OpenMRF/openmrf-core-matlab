function [rawdata, study_info, PULSEQ] = pulseq_read_meas_GE(study)

% Author: Maximilian Gram, University Hospital Wuerzburg, Wuerzburg, Germany; V1, 09.04.2026

% input: only study, which is the path to a .mat file containing General Electric rawdata
